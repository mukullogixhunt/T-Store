  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        ...
        if(categoryController.featuredCategories.isEmpty) return Center(child: Text('No Data Found',style: Theme.of(context).textTheme.bodyMedium!.apply(color: TColors.white)));
